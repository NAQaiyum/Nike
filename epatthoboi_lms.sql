...
--
-- Host: localhost:3306
-- Generation Time: May 01, 2024 at 05:54 AM
...
CREATE TABLE `students` (
  ...
  `institution_reg_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `role` int(11) DEFAULT '1' COMMENT '1->student, 2->teacher, 3->admin',
