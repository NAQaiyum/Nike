                            ...
                            <ul class="timeline">
                                <li>
                                    <a class="timeline-panel text-muted" href="javascript:void(0);">
                                        ...
                                        <p class="mb-0">All Site related changes will be there....</p>
                                    </a>
                                </li>
                                <li>
                                    <a class="timeline-panel text-muted" href="{{ route('admin::auth.role.index') }}">
                                        <h6 class="mb-0">Role-Permission</h6>
                                        <p class="mb-0">Set user Role and permission ...</p>
                                    </a>
                                </li>
